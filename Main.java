   ...
   switch(ver)
{
      ...
      case 1:do // Calcultor
   {
      ...
      System.out.println("3.Multiplication");                 //try breaking these up into Calc,Conv,and MainMenu
      ...
      for (int i=0; i<decimal7.length; i++ )
{
 ...
 break;//Breaks the Menus in Half
      ...
      case 2:do //Convertor 
   {
      ...
      switch(num1)
      {
         case 1:System.out.println("Number To Roman Numeral");
         ...
         if(num2>=1000)                           //swap the things that you input in the if else statements?
   {
            ...
            else if(num2>=1)
      {
         ...
         case 2:System.out.println("Roman Numeral To Number"); //****make in a class****  //Print Statements
